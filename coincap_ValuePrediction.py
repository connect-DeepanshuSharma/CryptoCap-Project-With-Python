import json
import math
import locale #add commas to numbers at every three places
import requests
...
table = PrettyTable(['Name', 'Ticker', '% of global cap', 'Current', '7.7T(Gold)', '36.8T(Narrow Money)','73T(World Stock Markets)','90.4T(Broad Money)','217T(Real Estate)','544T(Derivatives)'])
